...
<body style="background-color:  rgb(239, 239, 239);">
            ...
            <div style="margin-top:100px;">
              <div min-height:520px; 2px 10px rgba(0,0,0,0.45);">
                <div style="min-height:400px;padding:20px 10px;">
                    <h1 style="text-align: center;"><b>Tabla Tipos de Notificación</b></h1><br>
                    <form>
                      <table class="table table-hover">
                        <tr style="padding-top: 50px;">
                          <td><span>ID Tipo Nofiticación</span></td>
                          <td><input type="text" name=""  id="txt-id-tipo-notificacion" class="form-control" disabled="true"></td>
                        </tr>
                        <tr>
                          <td><span>Tipo Notificación</span></td>
                          <td><input type="text" id="txt-tipo-notificacion" class="form-control"
                          	disabled="true"></td>
                        </tr>
                        <tr>
                          <td>
    ...
    <div class="col-xs-12 col-lg-6 col-md-6 col-sm-12">
      <h1 style="padding-top: 120px; text-align: center;"><b>Tipos de Notificaciones Registradas</b></h1>
    	<div id="contenedor-tipos-notificaciones" style="align-content: center;" class="col-xs-12 col-lg-6 col-md-6 col-sm-12">
    	</div>
    </div>		

    <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12" style="font-size: 10px; padding-top: 40px; text-align: center;">Esta es una página restringida, si accede sin el permiso necesario se pueden tomar medidas legales</div>

    <script src="../js/jquery-3.2.1.min.js"></script>
    <script src="../js/bootstrap.min.js"></script>
    <script type="text/javascript" src="../js/controladorTipoNotificacion.js"></script>
</body>
</html>