...
<body style="background-color:  rgb(239, 239, 239);">
            ...
            <div style="margin-top:100px;">
              <div min-height:520px; 2px 10px rgba(0,0,0,0.45);">
                <div style="min-height:400px;padding:20px 10px;">
                    <h1 style="text-align: center;"><b>Tabla Tipos Usuarios</b></h1><br>
                    <form>
                      <table class="table table-hover">
                        <tr style="padding-top: 50px;">
                          <td><span>ID Tipo Usuario</span></td>
                          <td><input type="text" name=""  id="txt-id-tipo-usuario" class="form-control" disabled="true"></td>
                        </tr>
                        <tr>
                          <td><span>Tipo Usuario</span></td>
                          <td><input type="text" id="txt-tipo-usuario" class="form-control"
                          	disabled="true"></td>
                        </tr>
                        <tr>
    ...
    <div class="col-xs-12 col-lg-6 col-md-6 col-sm-12">
      <h1 style="padding-top: 120px; text-align: center;"><b>Tipos de Ususario registrados</b></h1>
    	<div id="contenedor-tipos-usuarios" style="align-content: center;" class="col-xs-12 col-lg-6 col-md-6 col-sm-12">
    	</div>
    </div>		
    ...
    <script type="text/javascript" src="../js/controladorTipoUsuario.js"></script>
</body>
</html>